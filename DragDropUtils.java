...
public class DragDropUtils {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		dragDropJavaScript(driver, dragElement, dropElement);
	}

	/**
	 * Method to perform drag drop using javascript
	 * @param driver WebDrivr
	 * @param dragElement [css selector]
	 * @param dropElement [css selector]
	 * @throws InterruptedException
	 */
	public static void dragDropJavaScript(WebDriver driver, String dragElement, String dropElement)
			throws InterruptedException {
